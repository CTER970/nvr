/*
 * web.c — 内嵌 Web 服务（HTTP API + 单页管理界面）
 *
 * 提供状态查询、配置管理、录像浏览、报警控制等 REST 接口，
 * 并托管前端单页应用。
 */
#include "web.h"
#include "log.h"
...
/* 建立 HTTP 监听 socket，并为每个连接创建客户端线程。 */
