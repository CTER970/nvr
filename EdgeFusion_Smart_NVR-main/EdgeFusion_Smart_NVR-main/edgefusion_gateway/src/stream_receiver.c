/*
 * stream_receiver.c — 输入码流接收（RTSP 拉流）
 *
 * 从前端 IPC / 编码器拉取 H.264 码流，分发给抓拍、录像、转发。
 */
...
/* 打开 RTSP 输入；成功通过出参交付输入上下文和视频流索引。 */
...
/* 持续连接 RTSP 源，读取视频包并分发给录像、抽帧和转发模块。 */
